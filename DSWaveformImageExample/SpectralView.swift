...
class SpectralView: UIView {
    ...
    private func drawSpectrum(context: CGContext) {
        ...
        for i in 0..<count {
            ...
            let magnitudeNorm = CGFloat(dbRatio) * viewHeight / 2
    ...
    private func drawLabels(context: CGContext) {
        ...
        attrStr.addAttribute(NSAttributedStringKey.foregroundColor, value: UIColor.yellow, range: NSMakeRange(0, freqLabelStr.characters.count))
        ...
        for i in 0..<labelStrings.count {
            ...
            attrStr.addAttribute(NSAttributedStringKey.foregroundColor, value: UIColor.yellow, range: NSMakeRange(0, str.characters.count))
